...
public:
    ...
    static vec2 lengthToSI(vec2 position);
    static vec2 lengthFromSI(vec2 position);

    static vec2 velocityToSI(vec2 position);
    static vec2 velocityFromSI(vec2 position);

    static vec2 lengthToAngstroms(vec2 position);
    static vec2 lengthFromAngstroms(vec2 position);
